...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cashgoldcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cashgoldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cashgoldcoin transaction") + "\n" +
              "  cashgoldcoin-tx [options] -create [commands]   " + _("Create hex-encoded cashgoldcoin transaction") + "\n" +
              "\n";
