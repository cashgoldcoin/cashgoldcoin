...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cashgoldcoin-project/cashgoldcoin>";
    const std::string URL_WEBSITE = "<https://cashgoldcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("CashGoldCoin version %s\n", FormatFullVersion());
}
